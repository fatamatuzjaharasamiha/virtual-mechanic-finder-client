        ...
        <div className=''>
            ...
            <div className='flex justify-center items-center h-screen'>
                ...
                <div className='mt-56'>
                    ...
                    <div className='flex'>
                        <button className='btn glass text-black rounded-none'>Provider</button>
                        <button className='btn glass text-black rounded-none'>Customer</button>
                        {/* <h1 className='p-3'>Provider</h1>
                        <h1 className='p-3'>Customer</h1> */}
                    </div>
